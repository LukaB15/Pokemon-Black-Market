...
const activated = "flex items-center justify-center flex-shrink-0 px-3 py-2 space-x-2  text-gray-600 hover:text-white border-2 border-darkest bg-lightest rounded-3xl"
    ...
    <>
      <div className="bg-white">
        <div className="pt-32  bg-white">
          <h1 className="text-center text-2xl font-bold text-gray-800 Pokemon">Let's buy them all !</h1>
        </div>
        <div className='flex items-center justify-center lg:hidden pb-8 pt-8'>
      ...
      >
        ...
        <div className="hidden lg:visiblemx-auto lg:grid max-w-1xl  grid-cols-1 gap-6 p-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-8 xl:grid-cols-10 overflow-y-hidden py-10    bg-white text-gray-800 ">
        <button className={typerecherche === '' ? activated : disActivated } onClick={ switchType('') }>
            <img className='w-8 h-8' src='pokeball.png' />
            <span>All</span>
          </button>
          <button className={typerecherche === 'fire' ? activated : disActivated }  onClick={ switchType('fire') }>
            <img className='w-8 h-8' src='fire.svg' />
            <span>Fire</span>
          </button>
          <button className={typerecherche === 'water' ? activated : disActivated } onClick={switchType('water')}>
            <img className='w-8 h-8' src='water.svg' />
            <span>Water</span>
          </button>
          <button className={typerecherche === 'grass' ? activated : disActivated } onClick={switchType('grass')}>
          <img className='w-8 h-8' src='grass.svg' />
            <span >Grass</span>
          </button>
          <button className={typerecherche === 'flying' ? activated : disActivated }  onClick={switchType('flying')}>
          <img className='w-8 h-8' src='flying.svg' />
            <span >Flying</span>
          </button>
          <button className={typerecherche === 'normal' ? activated : disActivated } onClick={switchType('normal')}>
          <img className='w-8 h-8' src='normal.svg' />
            <span>Normal</span>
          </button>
          <button className={typerecherche === 'electric' ? activated : disActivated } onClick={switchType('electric')}>
          <img className='w-8 h-8' src='electric.svg' />
            <span>Electric</span>
          </button>
          <button className={typerecherche === 'ice' ? activated : disActivated } onClick={switchType('ice')}>
          <img className='w-8 h-8' src='ice.svg' />
            <span>Ice</span>
          </button>
          <button className={typerecherche === 'fighting' ? activated : disActivated } onClick={switchType('fighting')}>
          <img className='w-8 h-8' src='fighting.svg' />
            <span>Fighting</span>
          </button>
          <button className={typerecherche === 'poison' ? activated : disActivated }  onClick={switchType('poison')}>
          <img className='w-8 h-8' src='poison.svg' />
            <span>Poison</span>
          </button>
          <button className={typerecherche === 'ground' ? activated : disActivated } onClick={switchType('ground')}>
          <img className='w-8 h-8' src='ground.svg' />
            <span>Ground</span>
          </button>
          <button className={typerecherche === 'psychic' ? activated : disActivated } onClick={switchType('psychic')}>
          <img className='w-8 h-8' src='psychic.svg' />
            <span>Psychic</span>
          </button>
          <button className={typerecherche === 'bug' ? activated : disActivated } onClick={switchType('bug')}>
          <img className='w-8 h-8' src='bug.svg' />
            <span>Bug</span>
          </button>
          <button className={typerecherche === 'rock' ? activated : disActivated } onClick={switchType('rock')}>
          <img className='w-8 h-8' src='rock.svg' />
            <span>Rock</span>
          </button>
          <button className={typerecherche === 'ghost' ? activated : disActivated } onClick={switchType('ghost')}>
          <img className='w-8 h-8' src='ghost.svg' />
            <span>Ghost</span>
          </button>
          <button className={typerecherche === 'dark' ? activated : disActivated } onClick={switchType('dark')}>
          <img className='w-8 h-8' src='dark.svg' />
            <span>Dark</span>
          </button>
          <button className={typerecherche === 'dragon' ? activated : disActivated } onClick={switchType('dragon')} >
          <img className='w-8 h-8' src='dragon.svg' />
            <span>Dragon</span>
          </button>
          <button className={typerecherche === 'steel' ? activated : disActivated } onClick={switchType('steel')}>
          <img className='w-8 h-8' src='steel.svg' />
            <span>Steel</span>
          </button>
          <button  className={typerecherche === 'fairy' ? activated : disActivated } onClick={switchType('fairy')}>
