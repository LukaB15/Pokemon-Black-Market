...
<section className="bg-white dark:bg-gray-900">
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
      ...
      <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 ">
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-4 transition ease-in-out duration-1000">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg max-w-lg mr-auto ml-auto" src="rocket.jpeg" alt="Bonnie Avatar" />
              </a>
              <div className="p-5">
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-4 transition ease-in-out duration-1000">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg max-w-lg mr-auto ml-auto" src="rocket.jpeg" alt="Jese Avatar" />
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Andreas S.</a>
          ...
          <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700 hover:-translate-y-4 transition ease-in-out duration-1000">
              <a href="#">
                  <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg max-w-lg mr-auto ml-auto" src="rocket.jpeg" alt="Michael Avatar" />
              </a>
              <div className="p-5">
                  <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                      <a href="#">Luka B.</a>
