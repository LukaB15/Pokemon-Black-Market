...
export default function SinglePokemon() {
  ...
  return (   
      ...
      <div className='bg-bck h-full flex flex-col '>
        ...
        <img src={singlePkmn.imgUrl} alt="pkmnimg" className='w-28 top-36 left-44 md:w-36 sm:top-96 lg:w-52 lg:top-96 xl:top-72 xl:w-72 2xl:w-96  max-w-xs 2xl:max-w-none absolute sm:left-36 2xl:left-28  z-10'  />
        <div className='bg-red-rocket bg-opacity-90 w-full sm:w-9/12  ml-0 sm:ml-28 mt-40 pt-10 pb-9 sm:pl-44 pl-10 rounded-lg absolute top-28 right-0 sm:right-16'>
          ...
          <h2 className='pokemon text-xs md:text-2xl text-white uppercase'> {singlePkmn.name}</h2>
          ...
          <h3 className='Pokemon mt-5 mb-2'>Type(s)</h3>
           <div className='mt-4 flex flex-row'>
            <p className="mr-1 Pokemon md:text-xl text-white uppercase text-xs">{singlePkmn.typeFirst}</p>
            <p className="mr-1 Pokemon md:text-xl text-white uppercase text-xs ml-5">{singlePkmn.typeSecond}</p>
           </div>
